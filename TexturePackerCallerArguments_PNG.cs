...
namespace TextureBatchPacker
{
	...
	{
		private static string GetTexturePackerArguments_PNG_8888(ConvertionParameters parameters)
		{
		...
		private static string GetTexturePackerArguments_PNG_888(ConvertionParameters parameters)
		{
			string plistFullPath;
			string argument;
		...
		private static string GetTexturePackerArguments_PNG_565(ConvertionParameters parameters)
		{
			string plistFullPath;
			string argument;
		...
		private static string GetTexturePackerArguments_PNG_INDEXED(ConvertionParameters parameters)
		{
			string plistFullPath;
			string argument;
